...
<head>
    ...
    <script src="includes/js/src/vendor/jquery.min.js"></script>
    <script src="includes/js/src/vendor/backburner.js-0.2.0.js"></script>
    <script src="includes/js/src/pineapple.js?version=<?=file_get_contents("/etc/pineapple/pineapple_version")?>" type="text/javascript" ></script>
    <script src="includes/js/src/deprecated_api.js" type="text/javascript" ></script>
